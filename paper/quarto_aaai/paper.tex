...
AR literature (see, e.g., \citep{venkatasubramanian2020philosophical})
...
\citep{sharma2020certifai}, threatening the equality of opportunity in
the system \citep{bell2024fairness}. Nonetheless, these phenomena are
not specific to CT.\\
...
regression in \citep{spooner2021counterfactual}), but there is little
consensus how to robustly extend the notion of CEs.\\
\indent Secondly, our approach is susceptible to training instabilities.
This problem has been recognized for JEMs \citep{grathwohl2020your} and
...
\citep{bischl2023hyperparameter}). \hfill \break
