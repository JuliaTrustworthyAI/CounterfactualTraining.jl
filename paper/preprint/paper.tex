...
Definition~\ref{def-explainability}). Instead, the choice has generally
been to improve the ability of XAI tools to identify the subset of
...
that faithfully generated counterfactuals are plausible (i.e.,
consistent with the data) and actionable. Formally, we define these
...
The characterization of faithfulness and plausibility in
Definition~\ref{def-explainability} is the same as in Altmeyer et al.
...
let \(T\) vary and consider the counterfactual search to be converged as
...
Definition~\ref{def-explainability}. This follows directly if we
consider samples drawn from \(p_\theta(\mathbf{x})\) as counterfactuals
because the JEM objective effectively minimizes the divergence between
the conditional posterior and \(p(\mathbf{x}|\mathbf{y}^{+})\). To
generate samples, Grathwohl et al.
(\citeproc{ref-grathwohl2020your}{2020}) rely on Stochastic Gradient
Langevin Dynamics (SGLD) using an uninformative prior for initialization
but we depart from their methodology. Instead of SGLD, we propose to use
...
of protecting immutable features in the presence of proxies that remain
unprotected. We address this in Section~\ref{sec-discussion}.

\subsection{Example: influence of counterfactual training on
explainability}\label{example-influence-of-counterfactual-training-on-explainability}
...
the model in panel (d) as the most explainable according to
Definition~\ref{def-explainability}.
...
\caption{\label{fig-poc}Illustration for Example~\ref{exm-grad} of how
CT improves model explainability.}
...
What are the effects of different hyperparameter choices wrt.
Equation~\ref{eq-obj}?
...
fairness.}} Related to the point above, we provide a tool that allows
...
\tabularnewline
  ...
  \toprule
  \textbf{Data} & \textbf{No. Train} & \textbf{No. Test} & \textbf{Batchsize} & \textbf{Decision Threshold} & \textbf{No. Counterfactuals} & \textbf{$\lambda_{\text{reg}}$} \\\midrule
  \endfirsthead
  \toprule
  \textbf{Data} & \textbf{No. Train} & \textbf{No. Test} & \textbf{Batchsize} & \textbf{Decision Threshold} & \textbf{No. Counterfactuals} & \textbf{$\lambda_{\text{reg}}$} \\\midrule
  \endhead
  \bottomrule
  \multicolumn{7}{r}{Continuing table below.}\\
  \bottomrule
  \endfoot
  \endlastfoot
  Adult & $2.6 \cdot 10^{4}$ & $5.01 \cdot 10^{3}$ & $1 \cdot 10^{3}$ & 0.75 & $5 \cdot 10^{3}$ & 0.25 \\
  California Housing & $1.65 \cdot 10^{4}$ & $3.1 \cdot 10^{3}$ & $1 \cdot 10^{3}$ & 0.5 & $5 \cdot 10^{3}$ & 0.25 \\
  Circles & $3.6 \cdot 10^{3}$ & 600 & 30 & 0.5 & $1 \cdot 10^{3}$ & 0.5 \\
  Credit & $1.06 \cdot 10^{4}$ & $1.92 \cdot 10^{3}$ & $1 \cdot 10^{3}$ & 0.5 & $5 \cdot 10^{3}$ & 0.25 \\
  GMSC & $1.34 \cdot 10^{4}$ & $2.47 \cdot 10^{3}$ & $1 \cdot 10^{3}$ & 0.5 & $5 \cdot 10^{3}$ & 0.5 \\
  Linearly Separable & $3.6 \cdot 10^{3}$ & 600 & 30 & 0.5 & $1 \cdot 10^{3}$ & 0.25 \\
  Moons & $3.6 \cdot 10^{3}$ & 600 & 30 & 0.9 & $1 \cdot 10^{3}$ & 0.25 \\
  Overlapping & $3.6 \cdot 10^{3}$ & 600 & 30 & 0.5 & $1 \cdot 10^{3}$ & 0.25 \\\bottomrule
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-gen-params-final-run-train}: Training Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-gen-params-final-run-eval}: Evaluation Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\tabularnewline
  ...
  Linearly Separable & Accuracy & Full & 0.999 & 0.00201 \\
  Linearly Separable & Accuracy & Vanilla & 1 & 0 \\
  Linearly Separable & F1-score & Full & 0.999 & 0.00201 \\
  Linearly Separable & F1-score & Vanilla & 1 & 0 \\
  ...
  Overlapping & Accuracy & Full & 0.915 & 0.00477 \\
  Overlapping & Accuracy & Vanilla & 0.917 & 0.00123 \\
  Overlapping & F1-score & Full & 0.915 & 0.00478 \\
  Overlapping & F1-score & Vanilla & 0.917 & 0.00124 \\\bottomrule
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-pen-final-run-train}: Training Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-pen-final-run-eval}: Evaluation Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\tabularnewline
  ...
  Linearly Separable & Accuracy & Full & 0.998 & 0.00772 \\
  Linearly Separable & Accuracy & Vanilla & 1 & 0 \\
  Linearly Separable & F1-score & Full & 0.998 & 0.00773 \\
  Linearly Separable & F1-score & Vanilla & 1 & 0 \\
  ...
  Overlapping & Accuracy & Full & 0.911 & 0.0217 \\
  Overlapping & Accuracy & Vanilla & 0.916 & 0.00236 \\
  Overlapping & F1-score & Full & 0.911 & 0.0219 \\
  Overlapping & F1-score & Vanilla & 0.916 & 0.00236 \\\bottomrule
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-train-final-run-train}: Training Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-train-final-run-eval}: Evaluation Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\tabularnewline
  ...
  Linearly Separable & Accuracy & Full & 0.999 & 0.00231 \\
  Linearly Separable & Accuracy & Vanilla & 1 & 0 \\
  Linearly Separable & F1-score & Full & 0.999 & 0.00231 \\
  Linearly Separable & F1-score & Vanilla & 1 & 0 \\
  ...
  Overlapping & Accuracy & Full & 0.914 & 0.00563 \\
  Overlapping & Accuracy & Vanilla & 0.918 & 0.00116 \\
  Overlapping & F1-score & Full & 0.914 & 0.0057 \\
  Overlapping & F1-score & Vanilla & 0.918 & 0.00116 \\\bottomrule
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Package Version (Reproducibility)}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-tune-train}: Training Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-tune-eval}: Evaluation Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-tune_lr-train}: Training Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Note \ref*{nte-tune_lr-eval}: Evaluation Phase}, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0]
...
\subsubsection{Plausibility}\label{plausibility-6}
