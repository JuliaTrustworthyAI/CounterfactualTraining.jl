...
accuracy \citep{goodfellow2016deep}. Modern advances in computing have
...
(DL) revolution, \citet{szegedy2013intriguing} showed that artificial
...
\citep{goodfellow2014explaining}---truly robust deep learning remains
unattainable even for models that are considered ``shallow'' by today's
standards \citep{kolter2023keynote}.
...
\citep{frankle2018lottery}. Similarly, \citet{zhang2021understanding}
...
e.g., \citep{oneil2016weapons}). Effective XAI tools can aid us in
...
\citet{wachter2017counterfactual} as an effective approach to achieve
...
compatible with plausible explanations \citep{altmeyer2024faithful}.
...
\pandocbounded{\includegraphics[keepaspectratio]{body_files/mediabag/../../paper/figures/poc.pdf}}
