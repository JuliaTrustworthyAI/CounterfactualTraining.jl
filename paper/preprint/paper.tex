...
(directly) mutable feature. For our intents and purposes, counterfactual training
...
\item
  (Actionability) Permutations \(\Delta\) are subject to some actionability
  constraints.
\end{enumerate}
...
\(\mathcal{S}(\mathbf{M}_\theta(\mathbf{x}^\prime))[y^+] \geq \tau\), where \(\mathcal{S}\) is the softmax function.\footnote{For
...
over the course of training, these two opposing effects gradually balance
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, breakable, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, toprule=.15mm, toptitle=1mm, left=2mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm]

@Cynthia, @Arie, I have tentatively phrased the above in terms of a
theorem and proof. This is something I've so far shied away from because
I feel a bit out of my depth when it comes to mathematical proofs. The
above makes intuitive sense to me, but I don't know for sure if it's
correct.
...
@Cynthia, @Arie, I'm including some preliminary results here but will
rerun experiments in the coming days. You'll notice some odd outlier
results (huge values) for the initial grid search
(Section~\ref{sec-app-initial}). My belief is that this is once again
due to \emph{ECCo} overshooting for some hyperparameter choices, that we
have discussed before. A simple solution to this story is to actually
impose domain constraints. Let's see what the final results show us (I
also still plan to make slight changes to the implementation), but in
any case I think it might even be worth to report results for the
initial grid search in the final appendix (they do include good results
for CT for certain hyperparameter ranges and highlight limitations
inherited from energy-based modelling).
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, toptitle=1mm, left=2mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm]

@Cynthia, @Arie, Figure~\ref{fig-mnist} shows much more plausible
(faithful) counterfactuals for a model with CT than the model with
conventional training (Figure~\ref{fig-mnist-vanilla}). In fact, this is
not even using \emph{ECCo+} and still showing better results than the
best results we achieved in our AAAI paper for JEM ensembles.
...
\subsection{Initial Grid Search}\label{sec-app-initial}

For the initial round of experiments we employed a different training
objective and procedure that led to promising results for some
hyperparameter choices, but suffered from training instabilities.
...
\item
  ...
  \tightlist
  \item
    Decisiono. Threshold: \texttt{0.75,\ 0.9,\ 0.95}
  \item
    \(\lambda_{\text{cost}}\): \texttt{0.0,\ 0.1}
  \item
    \(\lambda_{\text{div}}\): \texttt{0.1,\ 0.5,\ 1.0,\ 10.0}
  \item
...
\tabularnewline
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{0.01}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{-15.6}} & \color{blue}{\textbf{13.2}} \\
  ...
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{0.05}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-4.38}} & \color{blue}{\textbf{3.48}} \\
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{0.5}} & \color{blue}{\textbf{ECCo}} & \color{blue}{\textbf{-11.8}} & \color{blue}{\textbf{9.83}} \\
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{1}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{-15.7}} & \color{blue}{\textbf{13.3}} \\
  ...
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{5}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-4.38}} & \color{blue}{\textbf{3.48}} \\
  vanilla & 5 & \textit{REVISE} & -4.95 & 4.22 \\
  full & 10 & \textit{ECCo} & -2.31 & 0.735 \\
...
\tabularnewline
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{0}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{-15.4}} & \color{blue}{\textbf{12.9}} \\
  ...
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{0.001}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-4.41}} & \color{blue}{\textbf{3.48}} \\
...
\tabularnewline
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{0.01}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{-572}} & \color{blue}{\textbf{$1.25 \cdot 10^{3}$}} \\
  ...
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{0.05}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-11.7}} & \color{blue}{\textbf{12.8}} \\
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{0.5}} & \color{blue}{\textbf{ECCo}} & \color{blue}{\textbf{-7.09}} & \color{blue}{\textbf{7.51}} \\
  ...
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{1}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{$-1.16 \cdot 10^{3}$}} & \color{blue}{\textbf{$2.59 \cdot 10^{3}$}} \\
  vanilla & 1 & \textit{ECCo} & -15.5 & 17.3 \\
  vanilla & 1 & \textit{Generic} & -10.9 & 11.9 \\
  vanilla & 1 & \textit{REVISE} & -11.3 & 13.1 \\
  full & 5 & \textit{ECCo} & -2.57 & 2.07 \\
  full & 5 & \textit{Generic} & $-1.17 \cdot 10^{28}$ & $2.66 \cdot 10^{28}$ \\
  full & 5 & \textit{REVISE} & -530 & $1.16 \cdot 10^{3}$ \\
  vanilla & 5 & \textit{ECCo} & -15.5 & 17.2 \\
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{5}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-11.7}} & \color{blue}{\textbf{12.7}} \\
  vanilla & 5 & \textit{REVISE} & -11.3 & 13.1 \\
  full & 10 & \textit{ECCo} & -1.76 & 0.974 \\
  ...
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{10}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-10.9}} & \color{blue}{\textbf{11.9}} \\
  vanilla & 10 & \textit{REVISE} & -11.3 & 13.1 \\
  full & 15 & \textit{ECCo} & -1.37 & 0.365 \\
...
\tabularnewline
  ...
  full & 0.05 & \textit{Generic} & -1.21 & 0.356 \\
  full & 0.05 & \textit{REVISE} & $-5.91 \cdot 10^{27}$ & $1.36 \cdot 10^{28}$ \\
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{0.05}} & \color{blue}{\textbf{ECCo}} & \color{blue}{\textbf{-9.35}} & \color{blue}{\textbf{7.32}} \\
  vanilla & 0.05 & \textit{Generic} & -8.85 & 6.87 \\
  vanilla & 0.05 & \textit{REVISE} & -8.52 & 6.76 \\
  full & 0.1 & \textit{ECCo} & -1.2 & 0.383 \\
  full & 0.1 & \textit{Generic} & -1.5 & 0.735 \\
  full & 0.1 & \textit{REVISE} & $-3.06 \cdot 10^{26}$ & $7.7 \cdot 10^{26}$ \\
  vanilla & 0.1 & \textit{ECCo} & -9.33 & 7.32 \\
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{0.1}} & \color{blue}{\textbf{Generic}} & \color{blue}{\textbf{-8.88}} & \color{blue}{\textbf{6.86}} \\
  vanilla & 0.1 & \textit{REVISE} & -8.68 & 6.81 \\
  full & 0.5 & \textit{ECCo} & -1.12 & 0.217 \\
  ...
  full & 5 & \textit{Generic} & -1.21 & 0.363 \\
  \color{blue}{\textbf{full}} & \color{blue}{\textbf{5}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{$-1.1 \cdot 10^{28}$}} & \color{blue}{\textbf{$2.5 \cdot 10^{28}$}} \\
  ...
  full & 10 & \textit{Generic} & -1.49 & 0.702 \\
  full & 10 & \textit{REVISE} & $-3.74 \cdot 10^{26}$ & $9.09 \cdot 10^{26}$ \\
  vanilla & 10 & \textit{ECCo} & -9.31 & 7.33 \\
  vanilla & 10 & \textit{Generic} & -8.87 & 6.86 \\
  \color{blue}{\textbf{vanilla}} & \color{blue}{\textbf{10}} & \color{blue}{\textbf{REVISE}} & \color{blue}{\textbf{-8.69}} & \color{blue}{\textbf{6.83}} \\
  full & 15 & \textit{ECCo} & $-3.31 \cdot 10^{13}$ & $7.54 \cdot 10^{13}$ \\
  full & 15 & \textit{Generic} & -1.22 & 0.37 \\
...
Since our experiments have largely involved highly parallel tasks and
small models, we have made extensive use of multi-processing.
