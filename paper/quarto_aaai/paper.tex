...
\subcaption{\label{fig-mnist-ce}\emph{Plausibility}: faithful
counterfactuals (\emph{ECCCo}).}
...
pixels). CT produces plausible counterfactuals (a) and is insensitive to
...
effect: the model (bottom) is insensitive (blue) to the protected rows
of pixels; details are reported in the appendix.
