...
fig_caption = "Average outcomes for the plausibility measure across key hyperparameters. This shows the % change from the baseline model for the distance-based implausibility metric (\$\\text{IP}\$). Boxplots indicate the variation across evaluation runs and test settings (varying parameters for *ECCCo*)."
