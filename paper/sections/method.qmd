...
It is worth highlighting that @prp-mtblty assumes independence of features. This raises a valid concern about the effect of protecting immutable features in the presence of proxies that remain unprotected. We address this in @sec-discussion.

## Example: influence of counterfactual training on explainability
...
![Illustration for @exm-grad of how CT improves model explainability.](/paper/figures/poc.svg){#fig-poc}