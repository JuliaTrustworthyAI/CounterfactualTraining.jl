...
domain, if the previous gradient step moved resulted in updated feature
values out of the domain. Mutability constraints can similarly be
enforced by simply clipping gradients to ensure that features are only
