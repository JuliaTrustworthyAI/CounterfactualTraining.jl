...
:::
:::{.column width='50%'}
![Faithful counterfactuals for same MLP with CT (*ECCo*).](www/poc_model_ct_ecco.png){#fig-mnist-model-ct-ecco}
:::
::::
...
- Lots of open tasks and questions (see [issue](https://github.com/JuliaTrustworthyAI/CounterfactualTraining.jl/issues/8))
    1. Add MMD to measure plausibility.
    2. Evaluate adversarial robustness and generative capacity. Compare to AT, JEM.
    3. ... 
