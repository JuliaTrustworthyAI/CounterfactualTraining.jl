...
percentage reduction in costs with protected features. \textbf{Accuracy}
(columns 4-7): test accuracies and robust accuracies (\(\text{Acc}^*\))
for CT and the baseline (BL). Counterfactual outcomes in columns 1-3 are
