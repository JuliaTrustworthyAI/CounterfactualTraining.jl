...
CT (bottom). First column is a random factual 0 (blue). Columns 2 to 5
are corresponding \emph{ECCo} counterfactuals in target classes 1 to 4.
Columns 6 to 10 show integrated gradients averaged over all test images
in classes 5 to 9.}
...
Figure~\ref{fig-mnist} (columns 6-10) demonstrates that CT does have the
expected effect: sensitivity to protected features as per integrated
