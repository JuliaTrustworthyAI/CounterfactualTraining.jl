...
the distance penalty, \emph{ECCCo} uses an additional penalty component
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-train-default}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-eval-default}: Evaluation Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
Section~\ref{sec-app-grid}. For the main results, we tune a small set of
key hyperparameters (Section~\ref{sec-app-tune}). The final choices for
the main results are presented for each data set in
...
produce the main table in the paper.}
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-gen-params-final-run-train}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
ext\{IP\}\$). Boxplots indicate the variation across evaluation runs and
test settings (varying parameters for \emph{ECCCo}). Data: Moons.}
...
from the baseline model for the distance-based implausibility metric (\$
ext\{IP\}\$). Boxplots indicate the variation across evaluation runs and
test settings (varying parameters for \emph{ECCCo}). Data: Overlapping.}
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-pen-final-run-train}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
from the baseline model for the distance-based implausibility metric (\$
ext\{IP\}\$). Boxplots indicate the variation across evaluation runs and
test settings (varying parameters for \emph{ECCCo}). Data: Circles.}
...
from the baseline model for the distance-based implausibility metric (\$
ext\{IP\}\$). Boxplots indicate the variation across evaluation runs and
test settings (varying parameters for \emph{ECCCo}). Data: Linearly
Separable.}
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-train-final-run-train}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-tune-train}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Note \ref*{nte-tune_lr-train}: Training Phase}, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, arc=.35mm, left=2mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
data sets took less than one hour (\textless1h) to complete.
