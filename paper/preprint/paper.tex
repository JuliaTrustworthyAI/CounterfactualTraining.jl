...
(\citeproc{ref-szegedy2013intriguing}{2013}) showed that artificial
...
Szegedy 2014})---truly robust deep learning remains unattainable even
for models that are considered ``shallow'' by today's standards
...
\textbf{Specifically, we propose counterfactual training (CT)}: a novel
training regime that aligns learned representations with plausible
explanations compliant with user requirements. The remainder of this
paper is structured as follows. Section~\ref{sec-lit} presents related
work, focusing on the link between adversarial examples and
counterfactual explanations. Then follow our main contributions:
...
\item
  In Section~\ref{sec-experiments}, through extensive experiments we
  demonstrate that CT substantially improves explainability without
  sacrificing predictive performance.
\end{enumerate}

We discuss the challenges in Section~\ref{sec-discussion} and conclude
in Section~\ref{sec-conclusion} that CT is a promising approach towards
...
the underlying data and (global) actionability constraints. To make the
desiderata for our framework more concrete, we follow Augustin, Meinke,
and Hein (\citeproc{ref-augustin2020adversarial}{2020}) in tying the
concept of explainability to the quality of CEs that can be generated
for a given model. The authors show that CEs---understood as minimal
input perturbations that yield some desired model prediction---tend to
be more meaningful if the underlying model is more robust to adversarial
...
``unlearn'' susceptiblity to such examples, AT can effectively remove
...
It is worth highlighting that \mbox{Prp. \ref{prp-mtblty}} assumes
...
\tightlist
\item
  To what extent does our proposed counterfactual training objective in
...
metric. \emph{MNIST} is the only dataset for which the two metrics
disagree.
...
learned by models without sacrificing predictive accuracy.
...
We test in-depth the impact of three types of hyperparameters; our
...
observed desired improvements in explainability when CT was combined
with conventional training and applied only for the final 50\% of epochs
of the complete training process. Put differently, CT may be a way to
improve the explainability of models in a fine-tuning manner.
...
\textbf{\emph{CT is subject to training instabilities.}} JEMs are
susceptible to instabilities during training
...
Still, we find that training instabilities can be successfully mitigated
by regularizing energy (\(\lambda_{\text{reg}}\)), generating
sufficiently many counterfactuals during each training epoch, and
including only mature counterfactuals for contrastive divergence.

\textbf{\emph{CT is sensitive to hyperparameter selection.}} Our method
benefits from the tuning of certain key hyperparameters (see
...
\textbf{\emph{CT increases the training time of models.}} CT can be more
...
\textbf{\emph{Interventions on features may impact fairness.}} We
provide a tool that allows practitioners to modify the sensitivity of a
model with respect to certain features, which may have implication for
the fair and equitable treatment of decision subjects. As protecting a
...
(\citeproc{ref-bell2024fairness}{Bell et al. 2024}). Still, these
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-gen-params-final-run-train}: Training Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-gen-params-final-run-eval}: Evaluation Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-pen-final-run-train}: Training Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-pen-final-run-eval}: Evaluation Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-train-final-run-train}: Training Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-train-final-run-eval}: Evaluation Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Package Version (Reproducibility)}, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, colframe=quarto-callout-warning-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-tune-train}: Training Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-tune-eval}: Evaluation Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-tune_lr-train}: Training Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, titlerule=0mm, title={Note \ref*{nte-tune_lr-eval}: Evaluation Phase}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colframe=quarto-callout-note-color-frame, breakable, opacityback=0, colback=white, bottomtitle=1mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6]
