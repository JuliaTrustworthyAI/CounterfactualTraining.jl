...
![*Plausibility*: faithful counterfactuals (*ECCCo*).](/paper/figures/mnist_ce.png){#fig-mnist-ce}

![*Actionability*: class-cond. integrated gradients.](/paper/figures/mnist_ig.png){#fig-mnist-ig}

Visual explanations for *MNIST*. Top and bottom rows (of images) show the results for BL and CT, respectively. Mutability constraints are imposed on the five top and bottom rows (of pixels). CT produces plausible counterfactuals (a) and is insensitive to protected features (b).
