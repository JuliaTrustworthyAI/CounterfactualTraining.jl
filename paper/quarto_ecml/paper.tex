...
in Equation~\ref{eq-impl-div} is equal to zero iff
...
\cite{wachter2017counterfactual} as a simple baseline approach,
...
\emph{ECCo}---the generator of \cite{altmeyer2023faithful} but without
