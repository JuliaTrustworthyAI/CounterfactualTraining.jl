...
Final hyperparameters used for the main results preseneted in @sec-experiments. Any hyperparameter not shown here is set to its default value (@nte-train-default).
