...
counterfactual training employs counterfactuals during the training
phase to minimize the divergence between learned representations and
plausible, actionable explanations. We demonstrate empirically and
theoretically that our proposed method facilitates training models that
deliver inherently desirable explanations while promoting robustness and
preserving high predictive performance of the models.
\end{abstract}
...
by 19\% on average; and (3) the adversarial robustness improves across
the board. Finally, we discuss open challenges in
