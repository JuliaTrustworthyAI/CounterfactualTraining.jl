...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, left=2mm, colback=white, coltitle=black, bottomtitle=1mm, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, bottomrule=.15mm, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, leftrule=.75mm, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, breakable, left=2mm, colback=white, coltitle=black, bottomtitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomrule=.15mm, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, leftrule=.75mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]
