...
The repository is structured like a standard Julia package with the main code base in `src/`, the documentation in `docs/` and the test suite in `test/`^[The latter two are both still incomplete]. Everything relating specifically to the paper lives under `paper/`.
