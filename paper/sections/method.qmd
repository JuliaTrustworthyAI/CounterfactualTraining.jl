...
Based on our analysis in @sec-lit, counterfactuals $\mathbf{x}^\prime$ can be repurposed as additional training samples [@luu2023counterfactual;@balashankar2023improving] or adversarial examples [@freiesleben2022intriguing;@pawelczyk2022exploring]. This leaves some flexibility wrt. the choice for $\text{advloss}(\cdot)$ in @eq-obj. An intuitive functional form, but likely not the only sensible choice, is inspired by adversarial training:
