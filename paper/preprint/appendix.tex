...
\makeatother
\subtitle{Counterfactual Training: Teaching Models Plausible and
...
\maketitle
\begin{abstract}
This is the supplementary appendix to our paper titled
...
\item
  \(\mathbf{x}^\prime_{t \leq T}\): a nascent counterfactual, defined as
  a counterfactual that has not yet converged.
\item
  \(\mathbf{x}^\prime_{T}\): a mature counterfactual, defined as a
  counterfactual that has either passed a threshold probability or
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-train-default}: Training Phase}, opacityback=0, colback=white]
...
practice in the related literature on CE. For our final results
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-eval-default}: Evaluation Phase}, opacityback=0, colback=white]
...
the percentile method. The underlying counterfactual evaluations are the
same as the ones used to produce the main table in the paper.}
...
establish the significance of our results. These are presented in
Table~\ref{tbl-ig}.

We observe substantial and statistically significant improvements for
seven out of nine datasets. For the synthetic datasets we observe
reduction in sensitivity to the protected feature in 3 out of 4 cases.
The only dataset negatively impacted by CT --- albeit with highly
variable results --- is \emph{Moon}, which clearly violates the
assumptions in Proposition 3.1. For the real-world datasets, the
reductions are over two-fold for \emph{Adult} and \emph{CH} and almost
three-fold for \emph{MNIST}. In case of \emph{Cred} we can fully prevent
the CT model from considering \emph{age} as a factor in classification.
Only for \emph{GMSC} we observe negative impacts of CT which we believe
is due to any or all of the following: a) data assumptions are violated;
b) the impact of other components of the CT objective outweighs expected
effects of feature protection; or c) the default baseline choice applied
consistently to all datasets is not appropriate for GMSC.

\begin{table}

\caption{\label{tbl-ig}Average sensitivity \(\pm\) bootstrapped standard
errors of protected features as per standardized integrated gradients.}
...
S[table-format=2.2(2.2)]
  ...
  MNIST & 0.18 \pm 0.01 & 0.41 \pm 0.01 \\\bottomrule
\end{tabular}
...
\item
  ...
  (\citeproc{ref-ven2020philosophical}{2020}) propose introducing an
  upper bound on costs of the flipset (i.e.~the set of valid CE),
  arguing that valid but highly costly counterfactuals are not useful to
  individuals in practice. In a similar fashion, it could be argued that
  there should be an upper bound on the implausibility of
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-gen-params-final-run-train}: Training Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-gen-params-final-run-eval}: Evaluation Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-pen-final-run-train}: Training Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-pen-final-run-eval}: Evaluation Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-train-final-run-train}: Training Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-train-final-run-eval}: Evaluation Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-tune-train}: Training Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-tune-eval}: Evaluation Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-tune_lr-train}: Training Phase}, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, left=2mm, bottomrule=.15mm, leftrule=.75mm, title={Note \ref*{nte-tune_lr-eval}: Evaluation Phase}, opacityback=0, colback=white]
...
performance. All of our code will be provided to reviewers of this work
and open-sourced upon publication. The code is commented with clearly
marked references to the paper (look for
\texttt{\#\ -\/-\/-\/-\/-\ PAPER\ REF\ -\/-\/-\/-\/-}).
...
\bibitem[\citeproctext]{ref-ven2020philosophical}
...
Conference on Fairness, Accountability, and Transparency}, 284--93.
