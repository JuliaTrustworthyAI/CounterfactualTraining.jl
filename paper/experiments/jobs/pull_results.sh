...
confirm=$(bash -c "read -p \"About to copy results from long term storage directory ${OUTPUT_DIR} to $LOCAL_STORAGE_DIR. Are you sure you want to proceed? [y/n] \" -r confirm && echo \"\$confirm\"" | tr -d '\n')
