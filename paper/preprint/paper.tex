...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, arc=.35mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, colback=white, breakable, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, coltitle=black]
...
training is shown in Parameters~\ref{exr-gen-params-final-run-train}.
The corresponding evaluation grid used for these experiments is shown in
Parameters~\ref{exr-gen-params-final-run-eval}.

\begin{exercise}[Training
Phase]\protect\hypertarget{exr-gen-params-final-run-train}{}\label{exr-gen-params-final-run-train}
...
\item
  ...
  \item
    \(\lambda_{\text{yloss}}\): \texttt{1.0}
  \item
    \(\lambda_{\text{div}}\): \texttt{0.5}
  \item
    \(\lambda_{\text{reg}}\): \texttt{0.01}
  \item
...
Phase]\protect\hypertarget{exr-gen-params-final-run-eval}{}\label{exr-gen-params-final-run-eval}
