...
(referred to as \emph{gradient supervision})
...
might be relevant explanations. \cite{pawelczyk2022exploring} show that
CE and AE are equivalent under certain conditions and derive upper
...
guaranteed to provide recourse for individuals with high probability.
The approach builds on adversarial training,
