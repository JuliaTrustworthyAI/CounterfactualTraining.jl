...
The hyperparameter choices are shown in
Parameters~\ref{exr-gen-params-first-run}:

\begin{exercise}[Parameters]\protect\hypertarget{exr-gen-params-first-run}{}\label{exr-gen-params-first-run}
...
\tightlist
\item
  \textbf{generator\_params}:

  \begin{itemize}
  \tightlist
  \item
    \textbf{lambda\_cost}: 0.0, 0.001, 0.1
  \item
    \textbf{lambda\_energy}: 0.01, 0.05, 0.1, 0.5, 1.0, 5.0, 10.0, 15.0
  \item
    \textbf{lr}: 1.0
  \item
    \textbf{maxiter}: 20, 50, 100
  \item
    \textbf{opt}: sgd
  \end{itemize}
\item
  \textbf{generator\_type}: ecco, generic, omni, revise
\item
  \textbf{training\_params}:

  \begin{itemize}
  \tightlist
  \item
    \textbf{objective}: full, vanilla
  \end{itemize}
\end{itemize}
