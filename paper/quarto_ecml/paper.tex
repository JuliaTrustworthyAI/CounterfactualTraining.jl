...
\indent \emph{Hyperparameters of the CE generators.} First, we observe
...
\indent \emph{Hyperparameters for penalties.} We find that the strength
...
\(\lambda_{\text{reg}}\) may increase the variability in outcomes
(especially) when combined with high values of \(\lambda_{\text{div}}\)
or \(\lambda_{\text{adv}}\), this effect is not very pronounced.\\
\indent \emph{Other hyperparameters.} We observe that the effectiveness
...
Bayesian (e.g., \cite{snoek2012practical}) or gradient-based (e.g.,
\cite{franceschi2017forward}) optimization applicable.
