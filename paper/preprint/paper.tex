...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, titlerule=0mm, coltitle=black, left=2mm, bottomtitle=1mm, breakable, opacityback=0, rightrule=.15mm, toptitle=1mm, arc=.35mm, bottomrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6]
