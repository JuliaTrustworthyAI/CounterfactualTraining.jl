...
respect to the mutable feature and shorter on average than in (c). Thus,
we consider the model in panel (d) as the most explainable according to
...
domain, \(\mathbf{X}^+\subset\mathcal{X}^+\). We rely on the
distance-based metric used by Altmeyer et al.
...
aggregated across all test specifications of \emph{ECCo}. The following
two rows show the test accuracies for the model trained with CT and
...
\caption{\label{tbl-main}Key explainability and predictive performance
metrics for all datasets. \textbf{Plausibility}: the top five rows show
the percentage reduction in implausibility according to
Equation~\ref{eq-impl-dist} for varying degrees of the energy penalty
used for \emph{ECCo} at test time. The following row shows the reduction
in implausibility as measured by Equation~\ref{eq-impl-div} and
aggregated across all test specifications. \textbf{Accuracy}: The
following two rows show the test accuracies for the models trained with
CT and the baseline. \textbf{Actionability}: The final row present the
average reduction in costs when imposing mutability constraints.}
...
time, this has the effect of shorter counterfactual paths and hence
smaller average costs to individuals. To extend this to the non-linear
case, we test the effect of imposing mutability constraints empirically
for our synthetic data using the same evaluation scheme as above. The
final row in Table~\ref{tbl-main} reports the average reduction in costs
for CT compared to the baseline, when imposing that either the first or
the second feature is immutable. In all cases, costs are reduced
substantially indicating that classifiers trained with CT are indeed
more sensitive to mutable features.
...
\emph{Proceedings of the JuliaCon Conferences}, 1:130. 1.
...
Conference on Machine Learning}, 1165--73. ICML'17. Sydney, NSW,
Australia: JMLR.org.
...
\emph{Proceedings of the 26th International Conference on Neural
Information Processing Systems - Volume 2}, edited by F. Pereira, C. J.
Burges, L. Bottou, and K. Q. Weinberger. Vol. 25. NIPS'12. Curran
Associates, Inc.
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-gen-params-final-run-train}: Training Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-gen-params-final-run-eval}: Evaluation Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-pen-final-run-train}: Training Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-pen-final-run-eval}: Evaluation Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-train-final-run-train}: Training Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-train-final-run-eval}: Evaluation Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Package Version (Reproducibility)}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-tune-train}: Training Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-tune-eval}: Evaluation Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-tune_lr-train}: Training Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, rightrule=.15mm, colback=white, arc=.35mm, title={Note \ref*{nte-tune_lr-eval}: Evaluation Phase}, coltitle=black, opacityback=0, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable]
