...
function get_parallelizer(pllr_type::String; threaded::Bool=true, storage_dir::String=tempdir())
    # Multi-threading
    ...
    if pllr_type == "mpi"
        ...
        # Active comm:
        pllr = MPIParallelizer(MPI.COMM_WORLD; threaded=threaded, storage_dir=storage_dir)
    end
